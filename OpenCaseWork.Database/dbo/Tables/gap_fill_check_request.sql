CREATE TABLE [dbo].[gap_fill_check_request] (
    [gap_fill_check_request_id] INT           IDENTITY (1, 1) NOT NULL,
    [gap_fill_id]               INT           NULL,
    ...
    [tenant_id]                 INT           NULL,
    CONSTRAINT [PK_gap_fill_check_request] PRIMARY KEY CLUSTERED ([gap_fill_check_request_id] ASC) WITH (FILLFACTOR = 90)
);
